...
#define PY_OPCODES(X) \
  ...
  X(LOAD_FIELD,                        186) \
  X(STORE_FIELD,                       187) \
  X(BUILD_CHECKED_LIST,                188) \
  X(LOAD_TYPE,                         189) \
  X(CAST,                              190) \
  X(LOAD_LOCAL,                        191) \
  X(STORE_LOCAL,                       192) \
  X(PRIMITIVE_BOX,                     193) \
  X(POP_JUMP_IF_ZERO,                  194) \
  X(POP_JUMP_IF_NONZERO,               195) \
  X(PRIMITIVE_UNBOX,                   196) \
  X(PRIMITIVE_BINARY_OP,               197) \
  X(PRIMITIVE_UNARY_OP,                198) \
  X(PRIMITIVE_COMPARE_OP,              199) \
