...
static int64_t xxclassloader_bar(PyObject* self, int64_t f) {
  return f;
}
...
static int64_t xxclassloader_neg(PyObject* self) {
  return -1;
}
...
static PyObject* traverse_heap(PyObject* Py_UNUSED(self), PyObject* Py_UNUSED(args)) {
